...
@section('content')
  ...
  <div class='row'>
        <div class="col-md-6">
            ...
            <!-- Form input -->
            {!! Form::open(['url' => 'posts', 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title text-semibold">Add Video</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group has-feedback has-feedback-left{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-9">
                                ...
                                @endif
                                <span class="help-block">
                                    (Required) - Use a descriptive title because this will also serve as the URL and help Google indexing
                                </span>
                            </div>
                        </div>

                        <div class="form-group has-feedback has-feedback-left{{ $errors->has('video') ? ' has-error' : '' }}">
